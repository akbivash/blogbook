...
const Homepage = () => {
  return  <>
    ...
    <div className='grid  gap-3 text-center p-2 '>
     ...
     <p className='my-2   text-xl tracking-wide'>great interactive tutorials and full of coding exercises</p>
 ...
 <img src="https://cdn-icons-png.flaticon.com/512/9746/9746243.png" className=' w-[80%]  object-cover' alt="" />
     ...
     <div className='text-center flex-1 '>
      ...
      <p className='py-4   w-[80%] mx-auto text-lg text-gray-500'>
...
<div className='px-4 grid  gap-20 sm:px-10 text-center md:flex mx-auto  lg:w-[90%]'>
